import json
import unittest
from request_handler.request_handler import JsonJobRequestValidator, JsonAuthRequestValidator
...
class TestJsonRequestValidator(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.auth_validator = JsonAuthRequestValidator()
        self.jobs_validator = JsonJobRequestValidator()

    def test_validate_request_1a(self):
        """
        Test that the base :attr:`valid_request_json_file` is valid.
        """
        self.assertTrue(self.jobs_validator.validate_request(self.valid_job_request_data)[0])
    ...
    def test_validate_request_1c(self):
        ...
        self.assertFalse(self.jobs_validator.validate_request(self.valid_job_request_data)[0])
    ...
    def test_validate_request_2a(self):
        ...
        """
        self.assertFalse(self.jobs_validator.validate_request(self.invalid_job_request_data)[0])
    ...
    def test_validate_request_3a(self):
        ...
        """
        self.assertTrue(self.auth_validator.validate_request(self.valid_auth_request_data)[0])
    ...
    def test_validate_request_5a(self):
        ...
        self.assertFalse(self.auth_validator.validate_request(self.valid_auth_request_data)[0])
