...
# TODO: Convert from the scheduler handlers to the evaluation handlers
...
def main():
    ...
    resource_manager = RedisManager("evaluations", redis_host=redis_host, redis_port=redis_port, redis_pass=redis_pass)
